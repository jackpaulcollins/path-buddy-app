...
module Users
  class RegisterFromOauthOp < BaseOp
    ...
    def perform
      ...
      output :user, ::Users::UserRegistrationOp.submit!(email: email, first_name: first_name, last_name: last_name, password: password, password_confirmation: password, time_zone: time_zone).user
    end
